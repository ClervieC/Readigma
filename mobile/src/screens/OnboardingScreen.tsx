...
const STEPS = [
  {
    ...
    title: 'Bienvenue sur\nReadigma',
    desc: 'Ton compagnon de lecture. Suis ta progression, découvre de nouveaux livres et partage ton aventure littéraire.',
  },
  {
    icon: '🎲',
    iconColor: colors.cyan,
    title: 'Découvre\nton prochain livre',
    desc: 'Tu ne sais pas quoi lire ? Lance le dé ! Readigma pioche dans ta pile "À lire" et te fait une suggestion au hasard.',
  },
  {
    icon: '📚',
    iconColor: '#A78BFA',
    title: 'Gère ta\nbibliothèque',
    desc: 'Organise tes livres par statut : À lire, En cours, Terminé ou Abandonné. Tout ton univers littéraire en un endroit.',
  },
  {
    icon: '💭',
    iconColor: colors.pink,
    title: 'Réactions\nen temps réel',
    desc: 'Note tes émotions au fil de ta lecture avec des emojis et des notes. Crée ton journal de bord de lecteur.',
  },
  {
    icon: '👥',
    iconColor: colors.success,
    title: 'Lis avec\ntes amis',
    desc: 'Connecte-toi avec tes amis lecteurs, vois ce qu\'ils lisent et partage tes coups de cœur dans le fil d\'actualité.',
  },
];
