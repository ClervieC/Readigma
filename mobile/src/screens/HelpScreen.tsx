...
const FAQ = [
  {
    ...
    a: 'Dans "Découvrir" ou "Chercher", appuie sur un livre pour voir ses détails, puis choisis son statut : À lire, En cours ou Lu.',
  },
  {
    q: 'Comment suivre ma progression de lecture ?',
    a: 'Ouvre un livre "En cours" depuis ta bibliothèque, puis utilise le bouton "Mettre à jour" pour saisir ta page actuelle ou ton pourcentage.',
  },
  {
    q: 'Comment ajouter des amis ?',
    a: 'Va dans Profil → Amis lecteurs → onglet "Chercher". Tape le nom d\'un utilisateur et envoie-lui une demande.',
  },
  {
    q: 'Le fil d\'actualité est vide, pourquoi ?',
    a: 'Le feed affiche l\'activité de tes amis. Commence par en ajouter via la section "Amis lecteurs" dans ton profil.',
  },
  {
    q: 'Comment définir un objectif de lecture ?',
    a: 'Profil → Reading Goal. Tu peux choisir un nombre de livres à lire sur l\'année et suivre ta progression mois par mois.',
  },
  {
    q: 'Comment fonctionne "Choisir pour moi" ?',
    a: 'Dans l\'onglet Découvrir, ce bouton pioche au hasard un livre dans ta pile "À lire". Il faut avoir des livres dans cette liste.',
  },
  {
    q: 'Comment réagir à ma lecture ?',
    a: 'Sur la page de détail d\'un livre en cours, tu peux ajouter des réactions (emoji + note) à n\'importe quelle page. Elles apparaissent dans le feed de tes amis.',
  },
  {
    q: 'Mes notifications ne fonctionnent pas.',
    a: 'Assure-toi d\'avoir autorisé les notifications pour Readigma dans les paramètres de ton téléphone. Les notifs push arrivent dès qu\'un ami t\'envoie une demande.',
  },
];
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contactCard}>
          ...
          <Text style={styles.contactSub}>
            Notre équipe répond généralement sous 48 h.
          </Text>
