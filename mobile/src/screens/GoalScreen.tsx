...
const makeStyles = (colors: ColorPalette) => StyleSheet.create({
  ...
  congratsBadge: { backgroundColor: 'rgba(124,58,237,0.15)', borderRadius: radius.md, paddingHorizontal: 16, paddingVertical: 8, borderWidth: 1, borderColor: colors.border },
