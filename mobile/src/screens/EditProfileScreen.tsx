...
import {
  ...
  StyleSheet, SafeAreaView, ScrollView, Alert, Image,
} from 'react-native';
...
export default function EditProfileScreen({ navigation }: any) {
  ...
  const save = async () => {
    ...
    if (avatarUri !== user?.avatar_url) data.avatar_url = avatarUri;
...
const styles = StyleSheet.create({
  ...
  avatarBadge: {
    ...
    backgroundColor: colors.card, borderWidth: 2, borderColor: colors.bg,
    alignItems: 'center', justifyContent: 'center',
  },
  ...
  input: {
    ...
    padding: 12, color: colors.white, fontSize: 15,
    borderWidth: 1, borderColor: colors.divider,
  },
});
