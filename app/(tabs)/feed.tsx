...
const makeStyles = (colors: ColorPalette) => StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(107,63,115,0.3)', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  finishedBox: { backgroundColor: 'rgba(107,63,115,0.1)', borderRadius: radius.sm, padding: 10, borderWidth: 1, borderColor: 'rgba(107,63,115,0.3)' },
  ...
  reactionBox: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(107,63,115,0.1)', borderRadius: radius.sm, padding: 10, borderWidth: 1, borderColor: 'rgba(107,63,115,0.2)' },
